...
<html lang="pt-BR">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Barlow&family=Lexend:wght@100..900&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Outfit:wght@100..900&family=Poppins&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap"
      rel="stylesheet"
    />
    <link
      rel="shortcut icon"
      href="assets/images/logo-iara-games.svg"
      type="image/x-icon"
    />
    <!-- Bootstrap Icons -->
    <link
  ...
  <body>
    <nav class="navbar navbar-expand-lg px-3 px-lg-5 py-3">
      <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center gap-3 me-4" href="#">
          <img
            src="assets/images/logo-iara-games.svg"
            alt="Logo da Iara Games"
            width="59"
            height="49"
          />
          <span class="fw-bold fs-2 title">Iara Games</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul
            class="navbar-nav flex-grow-1 justify-content-center ms-lg-5 mb-3 mb-lg-0 gap-1"
          >
            <li class="nav-item">
              <a class="nav-link px-3 fw-semibold" href="pages/jogos.html"
                >Loja</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link px-3 fw-semibold" href="#">Comunidade</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-3 fw-semibold" href="#">Sobre</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-3 fw-semibold" href="pages/suporte.html"
                >Suporte</a
              >
            </li>
          </ul>
          ...
          <div
            class="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-3 ms-lg-auto"
          >
            <div class="position-relative search-wrapper">
              <i
                class="bi bi-search position-absolute top-50 translate-middle-y"
                style="
                  left: 12px;
                  font-size: 15px;
                  pointer-events: none;
            ...
            <a
              href="#"
              class="btn-warning text-nowrap px-4 fw-semibold login-btn"
            >
              Entrar
            </a>
          </div>
    ...
    <section class="hero">
      <div class="container-xl">
        <div class="row align-items-center g-4">
          <!-- Coluna do texto -->
          <div
            class="col-12 col-lg-7 order-2 order-lg-1 text-center text-lg-start"
          >
            <h1 class="hero-title">Descubra seus<br />próximos jogos</h1>
            <p class="hero-sub">
              A plataforma que te ajuda a encontrar os<br
                class="d-none d-md-block"
              />
              jogos desenvolvidos por brasileiros
            </p>
            <div
              class="hero-dots justify-content-center justify-content-lg-start"
            >
          ...
          <!-- Coluna do carrousel do jogo -->
          <div
            class="col-12 col-lg-5 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end"
          >
            <div
              id="heroCarousel"
            ...
            >
              <div class="carousel-inner">
                <!-- Slide 1: Enigma do Medo -->
                <div class="carousel-item active">
                  <div class="hero-card w-100">
                    <div class="hero-card-badge">Destaque</div>
                    <a href="pages/pages-game/page-interna-enigma-do-medo.html">
                      <img
                        src="assets/images/image-enigma-do-medo.jpg"
                        alt="Banner com a imagem do game Enigma do Medo"
                        class="hero-card-img enigma-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
                      <div class="hero-card-footer">
                        ...
                        <a
                          href="pages/pages-game/page-interna-enigma-do-medo.html"
                          class="buy-game-btn"
                        >
                          Comprar jogo <i class="bi bi-arrow-right"></i>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="carousel-item">
                  <div class="hero-card w-100">
                    ...
                    <a href="pages/jogos.html">
                      <img
                        src="assets/images/image-moonleap.jpg"
                        alt="Banner principal com a imagem Moonleap"
                        class="hero-card-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
                      <div class="hero-card-footer">
                        <span class="price">R$ 17,99</span>
                        <a href="pages/jogos.html" class="buy-game-btn">
                          Comprar jogo <i class="bi bi-arrow-right"></i>
                        </a>
                      </div>
                    </div>
                ...
                <div class="carousel-item">
                  <div class="hero-card w-100">
                    <div class="hero-card-badge">Novidade</div>
                    <a href="pages/jogos.html">
                      <img
                        src="assets/images/image-unsighted.jpg"
                        alt="Banner com a imagem do game UNSIGHTED"
                        class="hero-card-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
                ...
                <!-- Slide 4: A Investigação Póstuma -->
                <div class="carousel-item">
                  <div class="hero-card w-100">
                    <div class="hero-card-badge">Novidade</div>
                    <a href="pages/jogos.html">
                      <img
                        src="assets/images/image-investigacao-postuma.jpg"
                        alt="Banner com a imagem do game A Investigação Póstuma"
                        class="hero-card-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
                ...
                <div class="carousel-item">
                  <div class="hero-card w-100">
                    <div class="hero-card-badge">Lançamento</div>
                    <a href="pages/jogos.html">
                      <img
                        src="assets/images/image-onikura.jpg"
                        alt="Banner com a imagem do game Onikura"
                        class="hero-card-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
                ...
                <!-- Slide 6: Asleep: Ato 1 -->
                <div class="carousel-item">
                  <div class="hero-card w-100">
                    <div class="hero-card-badge">Lançamento</div>
                    <a href="pages/jogos.html">
                      <img
                        src="assets/images/image-asleep.png"
                        alt="Banner com a imagem do game Asleep: Ato 1"
                        class="hero-card-img"
                      />
                    </a>
                    <div class="hero-card-overlay">
    ...
    <!-- Video de fundo -->
    <!-- <video class="video" autoplay muted playsinline id="meu-video">
      <source src="./assets/images/bg-agua-video.mp4" type="video/mp4" />
    </video> -->
    <!-- F Video de fundo -->
    ...
    <section class="popular">
      <div class="container-xl">
        <!-- Cabeçalho da seção: título + "Ver todos" -->
        <div class="section-header">
          <h2>Popular no Brasil</h2>
          <a href="pages/jogos.html" class="link-ver-todos">Ver todos</a>
        </div>

        <div class="row g-4 g-xl-5 pb-5 align-items-start">
          <div class="col-12 col-lg-6">
            <div class="pop-container">
              <a href="pages/pages-game/page-interna-hell.clock.html">
                <img
                  src="assets/images/image-hellclock.jpg"
                  alt="Banner do jogo Hellclock"
                  class="img-hell"
              /></a>

              <div class="popular-preco">
                <span class="price-pop">R$ 100,00</span>
                <a
                  href="pages/pages-game/page-interna-hell.clock.html"
                  class="buy-game-btn"
                >
                  Comprar jogo <i class="bi bi-arrow-right"></i>
                </a>
          ...
          <div class="col-12 col-lg-6">
            <div class="game-title pt-0 pt-lg-3">
              ...
              <p class="white-text">
                Hell Clock é um RPG de ação roguelike brasileiro, desenvolvido
                pela Rogue Snail e publicado pela Mad Mushroom, ambientado na
                Guerra de Canudos (1896) com toques de terror gótico nordestino.
                O jogador controla Pajeú, um guerreiro que desce ao inferno para
                resgatar a alma de Antônio Conselheiro, enfrentando hordas
                demoníacas em campanhas rápidas.
              </p>
              <h3>Desenvolvedora: Rogue Snail</h3>
              <h3>Data de lançamento: 22/jul/2025</h3>
              <h3>Localidade: Brasília</h3>
            </div>
          </div>
        </div>
      </div>
    </section>
    <!-- Fim Popular no Brasil -->
            ...
            <div class="row align-items-center g-4 g-xl-5">
              ...
              <div class="col-12 col-lg-6">
                <div class="explore-map-side">
                  <h2 class="explore-title">Explore jogos pelo Brasil</h2>
                  <p class="explore-hint" id="explore-hint">
                    Clique em um Estado do mapa para ver os jogos em destaque
                    por lá
                  </p>

                  <!-- O SVG do mapa do Brasil -->
              ...
              <!-- Coluna dos Jogos em Destaque -->
              <div class="col-12 col-lg-6">
                <div class="explore-games-side">
                  <!-- Jogo principal em destaque (atualizado via JS ao clicar no mapa) -->
                  <div class="explore-featured" id="explore-featured">
                    <div class="explore-featured-badge" id="explore-featured-badge">
                      #1 em SP
                    </div>
                    <a
                      href="pages/pages-game/page-interna-enigma-do-medo.html"
                      id="explore-featured-link"
                    >
                      <img
                        src="assets/images/image-enigma-do-medo.jpg"
                        alt="Imagem para Banner jogo Enigma do Medo"
                        class="explore-featured-img"
                        id="explore-featured-img"
                      />
                    </a>
                  </div>

                  <div class="explore-thumbs" id="explore-thumbs">
                    <a href="pages/pages-game/page-interna-9-kings.html">
                      <img
                        src="assets/images/image-9kings.jpg"
                        alt="Imagem para o Banner jogo 9 Kings"
                      />
                    </a>
                    <a href="pages/pages-game/page-interna-dandara.html">
                      <img
                        src="assets/images/image-dandara.jpg"
                        alt="Imagem para o Banner jogo Dandara"
                      />
                    </a>
                    <a href="pages/pages-game/page-interna-sky-dust.html">
                      <img
                        src="assets/images/image-sky-dust.jpg"
                        alt="Imagem para o Banner jogo Sky Dust"
                      />
                    </a>
                  </div>
                  <p class="explore-empty d-none" id="explore-empty">
                    Ainda não temos jogos em destaque cadastrados para este
                    Estado. <a href="pages/jogos.html">Veja todos os jogos</a>.
                  </p>

                  <div class="explore-ver-mais">
                    <a
                      href="pages/jogos.html"
                      class="link-see-all link-ver-todos"
                      >Ver mais</a
                    >
                  </div>
                </div>
    ...
    <section class="ofertas">
      <div class="container-xl">
        ...
        <div class="section-header mb-4">
          <h2 class="ofertas-title">Ofertas</h2>
          <a href="pages/jogos.html" class="link-ver-todos">Ver todos</a>
        </div>

        <!-- Cards com scroll horizontal no mobile -->
        <div class="ofertas-scroll">
          <!-- Card 1 - Mullet Madjack -->
          <article class="ofertas-card ofertas-card--1">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-mullet-madjack.jpg"
                alt="Imagem para Banner jogo Mullet Madjack"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Mullet Madjack</h3>
              <p class="ofertas-desc">
                MULLET MAD JACK é um jogo de tiro em primeira pessoa FRENÉTICO
                de um jogador onde você está dentro de um ANIME da era dos vídeo
                cassetes! Incremente seu personagem até você alcançar o último
                andar. Faça seu melhor tempo ou tente de novo. Aqui a PRESSA É
                AMIGA DA PERFEIÇÃO!
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 49,95</span>
                  <span class="ofertas-new-price">R$ 29,96</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
              </div>
            </div>
          </article>
          ...
          <!-- Card 2 - Zueirama 2 -->
          <article class="ofertas-card ofertas-card--2">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-zueirama-2.jpg"
                alt="Imagem para Banner jogo Zueirama 2"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Zueirama 2</h3>
              <p class="ofertas-desc">
                Um jogo de aventura caótico cheio de minigames e referências a
                memes, onde você faz entregas de pizza, enfrenta robôs, faz
                trollagens e luta contra uma IA que quer acabar com a zueira.
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 19,99</span>
                  <span class="ofertas-new-price">R$ 14,99</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <!-- Card 3 - Asleep: Ato 1 -->
          <article class="ofertas-card ofertas-card--3">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-asleep.png"
                alt="Imagem para Banner jogo Asleep: Ato 1"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Asleep: Ato 1</h3>
              <p class="ofertas-desc">
                Sozinha, confusa e imersa em seus pesadelos numa realidade
                caótica. O único lugar seguro é o seu quarto, mas não por muito
                tempo... Vagueie por cenários inóspitos, enquanto foge de
                criaturas à espreita na escuridão para descobrir o que está
                acontecendo. Você está na pele de Ana Lúcia.
              </p>

              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 16,99 </span>
                  <span class="ofertas-new-price">R$ 13,59</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <!-- Card 4 - Aviãozinho -->
          <article class="ofertas-card ofertas-card--4">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-aviaozinho.jpg"
                alt="Imagem para Banner jogo Aviãozinho do Tráfico 3"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Aviãozinho do Tráfico</h3>
              <p class="ofertas-desc">
                Um jogo boomer shooter Brasileiro feito com o motor id tech 2!
                Atire, salte e se aventure por todo o estado do Rio de Janeiro.
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 19,00</span>
                  <span class="ofertas-new-price">R$ 10,50</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <!-- Card 5 - Horizon Chase -->
          <article class="ofertas-card ofertas-card--1">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-horizon-chase.jpg"
                alt="Imagem para Banner jogo Horizon Chase Turbo"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Horizon Chase Turbo</h3>
              <p class="ofertas-desc">
                Emocionante jogo de corrida arcade, inspirado pela geração dos
                clássicos jogos de corrida dos anos 90.
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 49,00</span>
                  <span class="ofertas-new-price">R$ 32,15</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <article class="ofertas-card ofertas-card--2">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-sludge-life.jpg"
                alt="Imagem para Banner jogo SLUDGE LIFE"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">SLUDGE LIFE</h3>
              <p class="ofertas-desc">
                Perambule por uma ilha minúscula em um planeta coberto de
                poluição, onde você é o promissor grafiteiro GHOST, um tranquilo
                delinquente que busca seu lugar na elite do grafite.
              </p>

              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 46,99 </span>
                  <span class="ofertas-new-price">R$ 34,99</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <!-- Card 7 - Lead The Dragon -->
          <article class="ofertas-card ofertas-card--3">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-lead-the-dragon.jpg"
                alt="Imagem para Banner jogo Lead The Dragon"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Lead The Dragon</h3>
              <p class="ofertas-desc">
                Junte-se à sua equipe e conquiste as estradas estreitas da
                América. Explore o mundo aberto, ganhe respeito e dinheiro
                competindo em corridas de rua, mas quebrar a lei vai te trazer
                sérios problemas com a polícia.
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 85,00</span>
                  <span class="ofertas-new-price">R$ 59,99</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
          ...
          <article class="ofertas-card ofertas-card--4">
            <div class="ofertas-img-wrap">
              <img
                src="assets/images/image-two-strikes.jpg"
                alt="Imagem para Banner jogo Two Strikes"
                loading="lazy"
              />
            </div>
            <div class="ofertas-info">
              <h3 class="ofertas-card-title">Two Strikes</h3>
              <p class="ofertas-desc">
                Mergulhe no coração do antigo Japão em Two Strikes, uma
                extravagância de combate 2D com animações deslumbrantes
                desenhadas à mão. Como um samurai destemido, monge guerreiro ou
                fora da lei audacioso, envolva-se em duelos eletrizantes onde
                cada golpe pode ser o seu último.
              </p>
              <div class="ofertas-bottom">
                <div>
                  <span class="ofertas-old-price">R$ 46,99 </span>
                  <span class="ofertas-new-price">R$ 23,49</span>
                </div>
                <button class="ofertas-btn">
                  Jogar <i class="bi bi-arrow-right"></i>
                </button>
    ...
    <!-- Area Formulário -->
    <form
      id="form-divulga-games"
      name="form-divulga-games"
      class="form-divulga-games"
      method="post"
      action=""
      novalidate
    >
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            <h2 class="titulo-divulgar-jogos">
              Deseja divulgar seus jogos na<br />Iara Games?<br />Envie seus
              dados
            </h2>

            <div class="row g-3">
              <div class="col-12">
                <label for="nome-usuario" class="sr-only">Nome completo</label>
                <input
                  type="text"
                  name="nome-usuario"
                  id="nome-usuario"
                  ...
                  autocomplete="name"
                />
                <span class="field-msg" id="msg-nome-usuario"></span>
              </div>

              <div class="col-12">
                <label for="email-usuario" class="sr-only">Email</label>
                <input
                  type="email"
                  name="email-usuario"
                  id="email-usuario"
                  ...
                  autocomplete="email"
                />
                <span class="field-msg" id="msg-email-usuario"></span>
              </div>

              <div class="col-12">
                <label for="tel-usuario" class="sr-only">Telefone</label>
                <input
                  type="text"
                  name="tel-usuario"
                  id="tel-usuario"
                  ...
                  required
                />
                <span class="field-msg" id="msg-tel-usuario"></span>
              </div>

              <div class="col-12">
                <label for="regiao-usuario" class="sr-only">Região</label>
                <select
                  id="regiao-usuario"
                  name="regiao-usuario"
                  class="select-custom"
                ...
                <span class="field-msg" id="msg-regiao-usuario"></span>
              </div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="row g-4 align-items-stretch">
          <!-- Coluna 1: Logo + Tagline + Idioma -->
          <div class="col-12 col-lg-6 footer-brand-col">
            <div class="footer-logo">
              <img
                ...
                height="33"
              />
              <h2 class="titulo-logo">Iara Games</h2>
            </div>
            <p class="footer-tagline">
              Plataforma de venda de jogos desenvolvidos por brasileiros ou
              jogos ambientados no Brasil.
            </p>
            <div class="footer-lang">
              <label>Idioma e País</label>
            ...
            <div class="footer-bottom">
              <span>2026 – Desenvolvido por grupo 17</span>
            </div>
          </div>

          <div class="col-12 col-lg-6 d-flex">
            <div class="footer-panel w-100">
              <div class="row g-4 g-lg-0">
                <!-- Coluna 2: Navegação -->
                <div class="col-12 col-md-5 footer-panel-nav">
                  <nav class="footer-links">
                    <a href="#">Sobre</a>
                    <a href="pages/jogos.html">Loja</a>
                    <a href="#">Comunidade</a>
                    <a href="#">Blog</a>
                ...
                <!-- Coluna 3: Redes + Legal -->
                <div class="col-12 col-md-7 footer-panel-aside">
                  ...
                  <div class="footer-links footer-links-legal">
                    <a href="#">Contato</a>
                    <a
                      href="pages/politica-privacidade.html"
                      class="link-yellow"
                    >
                      Políticas de Privacidade
                    </a>
                    <a href="pages/termos-condicoes.html" class="link-yellow">
                      Termos e Condições
                    </a>
                  </div>
                </div>
    ...
    <script src="assets/js/tel.mask.js"></script>

    <!-- Bootstrap JS (necessário para o menu hamburguer funcionar) -->
    <script
    ...
    <!-- Atividade JS: interações da home (mapa + formulário) -->
    ...
    <!-- <script>
      ...
      video.addEventListener("ended", function () {
        video.currentTime = 3; // 👈 começa do segundo 3 no loop
        video.play();
      });
    </script> -->
  </body>
